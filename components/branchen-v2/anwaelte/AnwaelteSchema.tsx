import { ANWAELTE_META_DESCRIPTION, ANWAELTE_V2_FAQS } from '@/lib/branchen/anwaelte-v2'
import { SITE_ORIGIN } from '@/lib/canonical'
import { jsonLdStringify } from '@/lib/safe-json-ld'

const PAGE_URL = `${SITE_ORIGIN}/branchen/anwaelte`

export default function AnwaelteSchema() {
  const graph = {
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Anwälte', item: PAGE_URL },
        ],
      },
      {
        '@type': 'Service',
        '@id': `${PAGE_URL}#service`,
        name: 'SEO für Anwälte in München',
      ...
      {
        '@type': 'FAQPage',
        mainEntity: ANWAELTE_V2_FAQS.map((f) => ({
          '@type': 'Question',
          name: f.q,
