export default function AnwaelteContactCta() {
  return (
    <section className="contact dark" id="kontakt-cta" aria-labelledby="kontakt-heading">
      ...
      <div className="wrap contact-inner">
        <div className="rv">
          ...
          <h2 id="kontakt-heading">Bereit für mehr Mandate über Google?</h2>
          <p className="lead">
            Wir analysieren die Google-Sichtbarkeit deiner Kanzlei, dein Bewertungsprofil und deine Website und zeigen
            dir einen konkreten Fahrplan. Sachlich fundiert, kostenlos und ohne Bindung.
          </p>
