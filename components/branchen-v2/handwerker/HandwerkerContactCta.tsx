export default function HandwerkerContactCta() {
  return (
    <section className="contact dark" id="kontakt-cta" aria-labelledby="kontakt-heading">
      ...
      <div className="wrap contact-inner">
        <div className="rv">
          ...
          <h2 id="kontakt-heading">Bereit für mehr Aufträge über Google?</h2>
          <p className="lead">
            Wir analysieren deine Google-Sichtbarkeit, dein Bewertungsprofil und deine Website und zeigen dir einen
            konkreten Fahrplan für deinen Betrieb. Kostenlos und ohne Bindung.
          </p>
