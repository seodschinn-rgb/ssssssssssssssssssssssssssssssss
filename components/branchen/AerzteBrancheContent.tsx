...
import '@/components/branchen/branchen-page.css'
import { aerztePageInnerHtml } from '@/lib/branchen/aerzte-page-html'
import { getBrancheBySlug } from '@/lib/branchen'
import type { BranchePageData } from '@/lib/branchen'

const RELATED_SLUGS = ['zahnaerzte', 'physiotherapeuten', 'handwerker'] as const

/**
 * Vollständiger Leitfaden-Text für /branchen/aerzte (HTML + eigenes Stylesheet).
 */
export default function AerzteBrancheContent() {
  ...
  return (
    <>
      <div className="branchen-page" dangerouslySetInnerHTML={{ __html: aerztePageInnerHtml }} />
