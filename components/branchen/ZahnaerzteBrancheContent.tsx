...
import '@/components/branchen/zahnaerzte-page.css'
import '@/components/branchen/branchen-img-cls.css'
import { zahnaerztePageInnerHtml } from '@/lib/branchen/zahnaerzte-page-html'
import { getBrancheBySlug } from '@/lib/branchen'
import type { BranchePageData } from '@/lib/branchen'

const RELATED_SLUGS = ['aerzte', 'physiotherapeuten', 'restaurants'] as const

/** Vollständiger Leitfaden für /branchen/zahnaerzte */
export default function ZahnaerzteBrancheContent() {
  ...
  return (
    <>
      <div dangerouslySetInnerHTML={{ __html: zahnaerztePageInnerHtml }} />
