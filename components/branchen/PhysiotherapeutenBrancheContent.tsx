...
const RELATED_SLUGS = ['aerzte', 'zahnaerzte', 'restaurants', 'handwerker', 'immobilienmakler'] as const

export default function PhysiotherapeutenBrancheContent() {
  ...
  return (
    <>
      <div dangerouslySetInnerHTML={{ __html: physiotherapeutenPageInnerHtml }} />
