...
const RELATED_SLUGS = ['handwerker', 'restaurants', 'hotels', 'immobilienmakler', 'steuerberater'] as const

export default function KfzWerkstattBrancheContent() {
  ...
  return (
    <>
      <div dangerouslySetInnerHTML={{ __html: kfzWerkstattPageInnerHtml }} />
