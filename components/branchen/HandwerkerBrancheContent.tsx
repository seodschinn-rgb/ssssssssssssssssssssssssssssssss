...
const RELATED_SLUGS = ['aerzte', 'kfz-werkstatt', 'immobilienmakler'] as const

/** Vollständiger Leitfaden für /branchen/handwerker */
export default function HandwerkerBrancheContent() {
  ...
  return (
    <>
      <div dangerouslySetInnerHTML={{ __html: handwerkerPageInnerHtml }} />
