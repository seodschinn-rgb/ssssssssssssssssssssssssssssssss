...
const RELATED_SLUGS = ['restaurants', 'immobilienmakler', 'handwerker', 'physiotherapeuten', 'steuerberater'] as const

export default function HotelsBrancheContent() {
  ...
  return (
    <>
      <div dangerouslySetInnerHTML={{ __html: hotelsPageInnerHtml }} />
